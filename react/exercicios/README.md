...
```sh
npm install --save sass-chokidar
```

Alternatively you may use `yarn`:

```sh
yarn add sass-chokidar
```
...
```diff
   "scripts": {
+    "build-css": "sass-chokidar src/ -o src/",
+    "watch-css": "npm run build-css && sass-chokidar src/ -o src/ --watch --recursive",
     "start": "react-scripts start",
     "build": "react-scripts build",
...
```
"build-css": "sass-chokidar --include-path ./src --include-path ./node_modules src/ -o src/",
"watch-css": "npm run build-css && sass-chokidar --include-path ./src --include-path ./node_modules src/ -o src/ --watch --recursive",
```
...
`sass` has been reported as having the following issues:

- `sass --watch` has been reported to have _performance issues_ in certain conditions when used in a virtual machine or with docker.

- Infinite styles compiling [#1939](https://github.com/facebookincubator/create-react-app/issues/1939)

- `sass` has been reported as having issues with detecting new files in a directory [#1891](https://github.com/sass/sass/issues/1891)

`sass-chokidar` is used here as it addresses these issues.
